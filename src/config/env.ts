...
const envSchema = z.object({
  ...
  REMEMBER_SESSION_TTL_HOURS: z.string().default('8760').transform((v) => Math.min(8760, Math.max(168, parseInt(v, 10) || 8760))),
...
export const env = {
  ...
  rememberSessionTtlHours: envValues.REMEMBER_SESSION_TTL_HOURS,
